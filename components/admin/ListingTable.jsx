...
export default function ListingTable({ headerDatas, datas, handleEdit, formDatas, detailsDatas, formComponent }) {
    return (
                ...
                <thead className="bg-base-100 text-black ">
                    <tr>
                        {headerDatas.map((headerDatas) => (
                            <ListingTableHeader data={headerDatas} key={headerDatas.value} />
                        ))}
                    </tr>
                </thead>
                <tbody>
